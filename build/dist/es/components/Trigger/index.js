...
var Trigger = function Trigger(props) {
    var collapsed = props.collapsed, onCollapsed = props.onCollapsed, onLogout = props.onLogout, _props$userName = props.userName, userName = _props$userName === void 0 ? '用户名' : _props$userName, userPic = props.userPic;
