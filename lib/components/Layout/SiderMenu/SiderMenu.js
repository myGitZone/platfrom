...
var Sider = _layout.default.Sider; // 是否第一次加载

var firstMount = true;

var defaultRenderLogo = function defaultRenderLogo(logo, collapsed) {
  if (!logo) {
    return '';
  } // 如果是字符串则直接用img进行展示
  ...
  if (typeof logo === 'string') {
    return _react.default.createElement("img", {
      className: collapsed ? _index.default['img-collapsed'] : _index.default.img,
      src: logo,
      alt: "logo"
    });
  ...
  _createClass(SiderMenu, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          trigger = _this$props$trigger === void 0 ? null : _this$props$trigger,
          renderSysChange = _this$props.renderSysChange;
      ...
      var siderClassName = (0, _classnames.default)(_index.default['ant-pro-sider-menu-sider'], (_classNames = {}, _defineProperty(_classNames, _index.default['fix-sider-bar'], fixSiderbar), _defineProperty(_classNames, _index.default.light, theme === 'light'), _classNames));
      return _react.default.createElement(Sider, {
        ...
        className: _index.default['ant-pro-sider-menu-logo'],
        id: "logo"
      }, _react.default.createElement("a", null, defaultRenderLogo(logo, collapsed), collapsed ? null : _react.default.createElement("h1", null, title))), _react.default.createElement("div", {
        className: _index.default.sys
      }, renderSysChange && renderSysChange()), _react.default.createElement(_BaseMenu.default, Object.assign({}, this.props, {
        mode: "inline",
